...
page_1_layout = html.Div([
    ...
    html.Div(id='page-1-content',children=[
        ...
        html.A("Equity Variance Analysis", href='/static/jupyter_nb/python_class_basics.html', target="_blank"),html.Br(),
        html.A("Equity PE Analysis", href='/static/jupyter_nb/python_class_basics.html', target="_blank"),html.Br(),
        html.A("Equity Variance Analysis", href='/static/jupyter_nb/python_class_basics.html', target="_blank"),html.Br()
...
index_page = html.Div(id='index-content',children=[
    ...
    children=[
        ...
        dbc.DropdownMenu(
            children=[
                dbc.DropdownMenuItem("More pages", header=True),
                dbc.DropdownMenuItem("General Equity Analysis", href="/page-1"),
                dbc.DropdownMenuItem("Page 3", href="#"),
            ],
            nav=True,
            in_navbar=True,
...
def set_loading_text(tickerInput,getStockDataButton):
    print('set loading text callback')
    print(tickerInput)
    print(getStockDataButton)
...
def update_output(tickerInput,loading_text_clicks,getStockDataButton):    
    print('calling update output callback')    
    ...
    # assets table      
    df_bs_assets = df_bs.loc[['Total Assets','Other Assets','Cash','Total Current Assets','Property Plant Equipment','Net Tangible Assets','Long Term Investments','Retained Earnings']]
    ...
    # liabilities table
    df_bs_liab = df_bs.loc[['Total Liab','Other Current Liab','Total Current Liabilities','Accounts Payable','Short Long Term Debt']]
    ...
    ratio_table_style={'margin-left':'20px','width': '70%','font-size':'12px'}
        
    return fig_out, quickRatio, pegRatio, balance_sheet_table_div, trailingPegRatio, currentRatio, shortRatio, stock_chart_style, ratio_table_style
